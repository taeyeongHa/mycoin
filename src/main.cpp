...
uint256 hashGenesisBlock("0x09301b842541cf652b15391426b6f632a35556ae221307fc716ec90b5fc1d3d5");
...
static const int64 nTargetSpacing = 2.5 * 60; // Mycoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa90109cc711eae286b7945f813fae07cdfad698fbeeebdfa14f61f96ce43b43e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049186939745b3a2a522ee38a996c05a033014f0f3effa4da13099736ac9e09397f46ce5bbb5198d63b851a5a52697c992d6a62c5886c0ffda03c2cc033612ee6b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1521339428;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085330259;

        if (fTestNet)
        {
            block.nTime    = 1521339428;
            block.nNonce   = 385554391;
        }
	...
	if (true && block.GetHash() != hashGenesisBlock)
	{
        ...
        assert(block.hashMerkleRoot == uint256("0x584af6af4a754d215031cdd287473df98bac21318093e9e4843277004736caab"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xd0, 0xf3, 0xbb }; // Mycoin: increase each by adding 2 to bitcoin's value.
